...
- (void)buttonAction{
    ...
    for(int i = 0; i < self.setting.totalCount; i ++){
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(i*weakSelf.setting.timeSpace * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            [weakSelf initCoinViewWithInt:i];
        });
    }
}
